...
type BrickComponentProps<T extends React.ElementType> = React.ComponentProps<T> & { as?: T } & BrickVariants
...
export const Brick = <T extends React.ElementType = typeof View>({
  ...
  return <Component {...props} style={[styles.brick, props?.style]} />
}
  ...
  return {
    brick: {
      variants: {
        ...
        backgroundColor: mapVariants({ ...theme.colors.background, ...theme.brand.colors }, 'backgroundColor'),

        borderRadius: mapVariants(theme.borderRadiuses, 'borderRadius'),
        borderRadiusBottomStart: mapVariants(theme.borderRadiuses, 'borderBottomStartRadius'),
        borderRadiusBottomEnd: mapVariants(theme.borderRadiuses, 'borderBottomEndRadius'),
        borderRadiusTopStart: mapVariants(theme.borderRadiuses, 'borderTopStartRadius'),
        borderRadiusTopEnd: mapVariants(theme.borderRadiuses, 'borderTopEndRadius'),

        flexDirection: mapVariants({ row: 'row', column: 'column', rowReverse: 'row-reverse', columnReverse: 'column-reverse' }, 'flexDirection'),
        alignItems: mapVariants({ stretch: 'stretch', center: 'center', flexStart: 'flex-start', flexEnd: 'flex-end' }, 'alignItems'),
